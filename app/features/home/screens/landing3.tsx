    ...
    <div className="w-full">
          ...
          <BlurFade delay={0.1} duration={0.6} inView>
            <div className="mb-8 text-center">
              ...
              <p className="text-muted-foreground mx-auto mb-8 max-w-2xl text-lg md:text-xl">
                인터넷 정보가 너무 많아서 혼란스러우신가요? 논문·가이드라인·전문가 의견을 바탕으로, 재발 걱정을 줄이는
                생활습관·보조제·치유 솔루션을 한 곳에서 정리해 드립니다.
              </p>
            </div>
            {/* Hero Image */}
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              >
                {loaderData.isAuthenticated ? "홈으로 이동" : "회원가입 후 빠르게 시작하기"}
              </Button>
            </div>
          </BlurFade>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <BlurFade delay={0.2} duration={0.6} inView>
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Evidence Base의 주요 장점</h2>
          ...
          <BlurFade delay={0.3} duration={0.6} inView>
            <Card className="neon-card cursor-pointer">
              <CardHeader>
                ...
                <CardDescription>모든 정보와 추천은 과학적 연구와 전문가 검증을 거칩니다</CardDescription>
              </CardHeader>
            </Card>
          </BlurFade>
          ...
          <BlurFade delay={0.4} duration={0.6} inView>
            <Card className="neon-card cursor-pointer">
              <CardHeader>
                ...
                <CardDescription>검증된 전문가와 의료진이 직접 관리하는 신뢰할 수 있는 정보</CardDescription>
              </CardHeader>
            </Card>
          </BlurFade>
          ...
          <BlurFade delay={0.5} duration={0.6} inView>
            <Card className="neon-card cursor-pointer">
              <CardHeader>
                ...
                <CardDescription>AI 기반 분석을 통해 개인 맞춤형 건강 관리 솔루션 제공</CardDescription>
              </CardHeader>
            </Card>
          </BlurFade>
          ...
          <BlurFade delay={0.6} duration={0.6} inView>
            <Card className="neon-card cursor-pointer">
              <CardHeader>
                ...
                <CardDescription>자연 기반 치유 프로그램으로 몸과 마음의 건강 회복</CardDescription>
              </CardHeader>
            </Card>
          </BlurFade>
          ...
          <BlurFade delay={0.7} duration={0.6} inView>
            <Card className="neon-card cursor-pointer">
              <CardHeader>
                ...
                <CardDescription>효과가 입증된 건강 제품만을 엄선하여 추천</CardDescription>
              </CardHeader>
            </Card>
          </BlurFade>
          ...
          <BlurFade delay={0.8} duration={0.6} inView>
            <Card className="neon-card cursor-pointer">
              <CardHeader>
                ...
                <CardDescription>최신 연구 결과와 트렌드를 반영한 지속적인 정보 업데이트</CardDescription>
              </CardHeader>
            </Card>
          </BlurFade>
        </div>
      ...
      <section className="bg-muted/50 py-20">
        <div className="container mx-auto px-4">
          <BlurFade delay={0.2} duration={0.6} inView>
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">서비스 이용 방법</h2>
              <p className="text-muted-foreground mx-auto max-w-2xl">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <BlurFade delay={0.3} duration={0.6} inView>
              <div className="text-center">
                ...
                <p className="text-muted-foreground">간단한 정보 입력으로 무료 회원가입을 완료하세요</p>
              </div>
            </BlurFade>
            ...
            <BlurFade delay={0.4} duration={0.6} inView>
              <div className="text-center">
                ...
                <p className="text-muted-foreground">건강 정보를 업데이트 하여 개인화된 서비스를 받으세요</p>
              </div>
            </BlurFade>
            ...
            <BlurFade delay={0.5} duration={0.6} inView>
              <div className="text-center">
                ...
                <p className="text-muted-foreground">블로그와 커뮤니티를 통해 건강 정보를 공유하고 소통하세요</p>
              </div>
            </BlurFade>
            ...
            <BlurFade delay={0.5} duration={0.6} inView>
              <div className="text-center">
                ...
                <h3 className="mb-2 text-xl font-semibold">서비스 이용</h3>
                <p className="text-muted-foreground">맞춤 추천 서비스와 AI 분석을 받고 건강 관리를 시작하세요</p>
              </div>
            </BlurFade>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <BlurFade delay={0.2} duration={0.6} inView>
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">이런 분들께 도움이 됩니다</h2>
            <p className="text-muted-foreground mx-auto max-w-2xl">
      ...
      <section className="bg-muted/50 py-20">
        <div className="container mx-auto px-4">
          <BlurFade delay={0.2} duration={0.6} inView>
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">서비스 개요</h2>
              <p className="text-muted-foreground mx-auto max-w-2xl">
              ...
              <Card className="rainbow-card mb-8 cursor-pointer">
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    모든 건강 정보와 서비스를 한 곳에서 관리할 수 있는 통합 플랫폼
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Link to="/products" className="block">
              <Card className="rainbow-card mb-8 cursor-pointer">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl md:text-3xl">검증된 건강 제품 추천</CardTitle>
                  <CardDescription className="text-base">
      ...
      <section className="container mx-auto px-4 py-20">
        <BlurFade delay={0.2} duration={0.6} inView>
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">주요 기능 및 특징</h2>
            <p className="text-muted-foreground mx-auto max-w-2xl">Evidence Base만의 차별화된 기능들을 만나보세요</p>
          </div>
        </BlurFade>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {[
            {
              title: "AI 건강 분석",
              description: "혈액검사 결과와 건강 데이터를 AI가 분석하여 개인 맞춤형 건강 리포트를 제공합니다.",
              icon: "🤖",
            },
            {
              title: "전문가 네트워크",
              description: "검증된 의료진과 건강 전문가들이 직접 관리하는 신뢰할 수 있는 정보를 제공합니다.",
              icon: "👨‍⚕️",
            },
            {
              title: "제품 리뷰 시스템",
              description: "실제 사용자들의 상세한 리뷰와 전문가 평가를 통해 신뢰할 수 있는 제품 정보를 제공합니다.",
              icon: "⭐",
            },
            {
              title: "커뮤니티 활동",
            ...
            {
              title: "건강 추적",
              description: "시간에 따른 건강 지표 변화를 추적하고 관리하여 건강 개선 효과를 확인할 수 있습니다.",
              icon: "📈",
            },
            {
              title: "맞춤형 추천",
              description: "개인의 건강 상태와 목표에 맞는 제품, 프로그램, 정보를 지능적으로 추천합니다.",
              icon: "🎯",
            },
          ].map((feature, index) => (
      ...
      <section className="bg-muted/50 py-20">
        <div className="container mx-auto px-4">
          <BlurFade delay={0.2} duration={0.6} inView>
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">사용자 후기 및 사례</h2>
              <p className="text-muted-foreground mx-auto max-w-2xl">
      ...
      <section className="container mx-auto px-4 py-20">
        <BlurFade delay={0.2} duration={0.6} inView>
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">서비스에 대한 약속</h2>
            <p className="text-muted-foreground mx-auto max-w-2xl">
              Evidence Base는 신뢰할 수 있는 건강 정보를 제공하기 위해 엄격한 기준을 적용합니다
            </p>
          </div>
        </BlurFade>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            {
              title: "과학적 검증",
              description: "모든 정보는 peer-reviewed 연구와 과학적 근거를 바탕으로 합니다",
            },
            {
              title: "전문가 검토",
              description: "의료진과 건강 전문가들이 직접 검토하고 승인한 정보만 제공합니다",
            },
            {
              title: "투명한 정보",
              description: "정보 출처와 검증 과정을 투명하게 공개하여 신뢰성을 보장합니다",
            },
            {
              title: "지속적 업데이트",
              description: "최신 연구 결과를 반영하여 정보의 정확성을 지속적으로 유지합니다",
            },
          ].map((item, index) => (
      ...
      <section className="bg-muted/50 py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            <BlurFade delay={0.2} duration={0.6} inView>
              <div className="mb-8 text-center">
                <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">서비스를 개발한 이유</h2>
                <p className="text-muted-foreground">
                  건강 정보의 혼란 속에서 신뢰할 수 있는 증거 기반 솔루션을 제공하고자 합니다
                </p>
              </div>
            </BlurFade>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-muted-foreground space-y-4">
                    <p>
                      오늘날 건강 정보는 넘쳐나지만, 그 중 많은 부분이 과학적 근거 없이 퍼지고 있습니다. Evidence Base는
                      이러한 문제를 해결하기 위해 탄생했습니다.
                    </p>
                    <p>
                      우리는 모든 사용자가 신뢰할 수 있는, 검증된 건강 정보에 접근할 수 있어야 한다고 믿습니다. 따라서
                      모든 정보와 추천은 엄격한 과학적 검증 과정을 거치며, 전문가들의 검토를 받습니다.
                    </p>
                    <p>
                      또한 개인 맞춤형 건강 관리를 통해 각자의 건강 목표를 달성할 수 있도록 지원합니다. AI 기술과 전문가
                      네트워크를 결합하여 최적의 건강 솔루션을 제공하는 것이 우리의 목표입니다.
                    </p>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="container mx-auto px-4 py-20">
        <BlurFade delay={0.2} duration={0.6} inView>
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">만든 사람 이야기</h2>
            <p className="text-muted-foreground mx-auto max-w-2xl">Evidence Base를 만든 팀을 소개합니다</p>
          </div>
        </BlurFade>
          ...
          <BlurFade delay={0.3} duration={0.6} inView>
            <Card>
              <CardContent className="pt-6">
                <div className="text-muted-foreground space-y-4">
                  <p>
                    Evidence Base는 건강과 기술에 열정을 가진 전문가들로 구성된 팀이 만들었습니다. 의료진, 데이터
                    과학자, 소프트웨어 엔지니어, 산림치유 전문가 등 다양한 분야의 전문가들이 협력하여 개발했습니다.
                  </p>
                  <p>
                    우리 팀은 개인의 건강이 삶의 질에 직접적인 영향을 미친다고 믿습니다. 따라서 과학적 근거와 전문가
                    지식을 바탕으로 사용자들이 건강한 선택을 할 수 있도록 돕는 것이 우리의 사명입니다.
                  </p>
                  <p>
                    Evidence Base는 단순한 정보 제공 플랫폼을 넘어, 사용자들의 건강 개선을 위한 파트너가 되고자 합니다.
      ...
      <section className="container mx-auto px-4 py-16">
        <BlurFade delay={0.2} duration={0.6} inView>
          <div className="mb-10 text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">주의사항</h2>
            <p className="text-muted-foreground mx-auto max-w-3xl text-sm md:text-base">
              ...
              정보를 바탕으로 주체적으로 건강 관리를 수행하도록 돕는 것을 목적으로 합니다. 아래 사항을 반드시
              확인해주세요.
            </p>
          </div>
        </BlurFade>
        ...
        <div className="container mx-auto px-4">
          <BlurFade delay={0.2} duration={0.6} inView>
            <BlurFade className="mx-auto max-w-3xl text-center">
              <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">지금 바로 시작하세요</h2>
              <p className="text-muted-foreground mb-8 text-lg">
                Evidence Base와 함께 건강한 삶을 시작하세요. 무료로 가입하고 모든 기능을 체험해보세요.
              </p>
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Button
                  size="lg"

...
DROP POLICY IF EXISTS "bot-message-room-members insert" ON "bot_message_room_members" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-message-room-members update" ON "bot_message_room_members" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-message-room-members delete" ON "bot_message_room_members" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-message-rooms insert" ON "bot_message_rooms" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-message-rooms update" ON "bot_message_rooms" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-message-rooms delete" ON "bot_message_rooms" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-messages insert ai" ON "bot_messages" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-messages insert user" ON "bot_messages" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-messages update" ON "bot_messages" CASCADE;--> statement-breakpoint
DROP POLICY IF EXISTS "bot-messages delete" ON "bot_messages" CASCADE;--> statement-breakpoint
